...
export default function Ikhityaar() {
      ...
      <div className="relative z-10 pt-20">
        ...
        >
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
            ...
            <span>/</span>
            <span className="text-gray-900">Project Ikhtiyaar</span>
          </div>
            ...
            <div className="flex items-center space-x-3 mb-4">
              <div>
                ...
                <p className="text-lg text-gray-600 mt-1">
                  Addresses an often-overlooked waste stream-used coffee
                  grounds.
                </p>
              </div>
            </div>
        ...
        >
          <div className="relative group cursor-pointer overflow-hidden rounded-2xl shadow-2xl">
            <img
              src="/projects/ikhtiyaar.jpg"
              alt="Project Ikhtiyaar"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-8 mb-6">
                  Project Ikhtiyaar addresses an often-overlooked waste
                  stream-used coffee grounds-by repurposing them into
                  eco-friendly materials. These include handcrafted clay
                  products and fuel-efficient coffee briquettes that offer a
                  sustainable alternative to conventional fuels. By giving a
                  second life to discarded grounds, the project helps combat
                  landfill overflow, reduce carbon emissions, and inspire
                  responsible waste disposal practices in urban settings.
                </p>
                <p className="text-gray-700 leading-8 mb-6">
                  The project has already made waves at national and
                  international platforms, reaching the Top 4 Early Stage
                  Finalists at the Enactus Nationals 2024 and winning the BRICS
                  Youth Entrepreneurship Idea Competition 2025. Ikhtiyaar
                  champions innovation in waste valorization and merges artistic
                  expression with environmental responsibility. With a clear
                  vision for growth, the project aims to scale its operations
                  and introduce a new wave of eco-conscious solutions in both
                  homes and industries.
                </p>
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
                  <p className="text-yellow-800 font-medium">
                    "Project Ikhityaar has not just given us income, but dignity
          ...
          >
            <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-8 text-center text-white">
              <h2 className="text-3xl font-bold mb-4">
                Want to Support Project Ikhtiyaar?
              </h2>
