      ...
      <div className="relative z-10 pt-20">
        ...
        >
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
            ...
            <span>/</span>
            <span className="text-gray-900">Project Noorani</span>
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-8 mb-6">
                  Project Noorani is where sustainability meets creativity. This
                  initiative upcycles floral waste collected from the Yamuna
                  banks and urban temples into naturally dyed fabrics and
                  handcrafted stationery. By using flowers like marigold, rose,
                  and hibiscus, we create vibrant hues for eco-printed textiles,
                  promoting sustainable fashion and reducing the environmental
                  burden of synthetic dyes. The project supports a circular
                  economy by transforming what would otherwise be discarded into
                  high-value products with a strong aesthetic and ecological
                  appeal.
                </p>
                <p className="text-gray-700 leading-8 mb-6">
                  Our range of products-scarves, pouches, greeting cards, and
                  notebooks-serves not just as eco-conscious merchandise, but
                  also as a reminder of the beauty of reuse. With each item, we
                  advocate for mindful consumption, celebrate cultural
                  craftsmanship, and spread awareness about nature-friendly
                  design practices. Through Noorani, we are redefining waste as
                  a resource and fashion as a form of advocacy.
                </p>
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
                  <p className="text-yellow-800 font-medium">
                    "Project Noorani has not just given us income, but dignity
          ...
          >
            <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-8 text-center text-white">
              <h2 className="text-3xl font-bold mb-4">
                Want to Support Project Noorani?
              </h2>
