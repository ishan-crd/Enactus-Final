...
export default function Dharang() {
      ...
      <div className="relative z-10 pt-20">
        ...
        >
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-500 mb-6">
            ...
            <span>/</span>
            <span className="text-gray-900">Project Dharang</span>
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-8 mb-6">
                  Launched in 2020, Project Dharang is a women-led initiative
                  that empowers rural women artisans by reviving traditional
                  craft techniques and creating sustainable income
                  opportunities. The project bridges the gap between traditional
                  craftsmanship and modern market demands.
                </p>
                <p className="text-gray-700 leading-8 mb-6">
                  Our mission is to preserve India's rich cultural heritage
                  while providing economic independence to women in rural
                  communities. Through skill development, market linkages, and
                  digital platforms, we've created a thriving ecosystem of
                  empowered women entrepreneurs.
                </p>
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
                  <p className="text-yellow-800 font-medium">
                    "Project Dharang has not just given us income, but dignity
          ...
          >
            <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-8 text-center text-white">
              <h2 className="text-3xl font-bold mb-4">
                Want to Support Project Dharang?
              </h2>
